...
ctaBody: >-
  Teams can build local durable agent setups with file-backed progress. Long jobs
  resume after a restart without renting a cloud workflow for durability alone.
